...
namespace Sitecore.Feature.Media.Specflow
{
    ...
    public partial class VideoInMediaCarouselFeature : Xunit.IUseFixture<VideoInMediaCarouselFeature.FixtureData>, System.IDisposable
    {
...
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Video in Media Carousel", "", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line 6
 testRunner.Given("Habitat website is opened on Main Page");
#line 7
 testRunner.When("User opens Home page");
#line hidden
...
#line 8
 testRunner.Then("Following video presents", ((string)(null)), table1);
#line hidden
...
this.ScenarioSetup(scenarioInfo);
#line 16
 testRunner.Given("Habitat Content Editor was opened");
#line hidden
...
#line 21
 testRunner.And("<Sitecore CMS.mp4> thumbnail should be added to Media library Habitat, Saved and " +
                    "Published", ((string)(null)), table3);
#line 25
 testRunner.When("User starts Video item creation under Habitat Shared Media");
#line 27
 testRunner.And("User inserts <Sitecore CMS.mp4 path> into Link to video: field");
#line 28
 testRunner.And("User inserts <Habitat-001-wide path> image into Thumbnail field");
#line 29
 testRunner.And("User clicks Save button on Content Editor Ribbon");
#line 30
 testRunner.And("User selects Carousel item");
#line 32
 testRunner.And("User moves <Sitecore CMS.mp4> item to Selected section");
#line 34
 testRunner.And("User clicks Save button on Content Editor Ribbon");
#line 35
 testRunner.And("User publishes /sitecore/content/Shared/Media item with sub-items");
#line 36
 testRunner.And("User opens Home page");
#line 37
 testRunner.Then("Carousel element presents at Habitat Home page");
#line hidden
...
#line 38
 testRunner.And("Following video presents", ((string)(null)), table4);
#line hidden
...
#line 42
 testRunner.And("Following thumbnail presents", ((string)(null)), table5);
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table7.AddRow(new string[] {
                        "/-/media/Habitat/Videos/Sitecore-Experience.mp4"});
#line 65
 testRunner.And("Following video presents", ((string)(null)), table7);
#line hidden
            ...
            table8.AddRow(new string[] {
                        "/-/media/Habitat/Videos/Sitecore CMS.mp4"});
#line 68
 testRunner.And("Following video absents", ((string)(null)), table8);
#line hidden
            ...
            table9.AddRow(new string[] {
                        "/-/media/Habitat/Images/Wide/HabitatTest.jpg"});
#line 71
 testRunner.And("Following thumbnail presents", ((string)(null)), table9);
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table11.AddRow(new string[] {
                        "/-/media/Habitat/Videos/Sitecore-Experience.mp4"});
#line 93
 testRunner.And("Following video presents", ((string)(null)), table11);
#line hidden
            ...
            table12.AddRow(new string[] {
                        "/-/media/Habitat/Videos/Sitecore CMS.mp4"});
#line 96
 testRunner.And("Following video absents", ((string)(null)), table12);
#line hidden
            ...
            table13.AddRow(new string[] {
                        "/-/media/Habitat/Images/Wide/HabitatTest.jpg"});
#line 99
 testRunner.And("Following thumbnail absents", ((string)(null)), table13);
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table15.AddRow(new string[] {
                        "/-/media/Habitat/Videos/Sitecore CMS.mp4"});
#line 122
 testRunner.And("Following video presents", ((string)(null)), table15);
#line hidden
            ...
            table16.AddRow(new string[] {
                        "/-/media/Habitat/Images/Wide/HabitatTest.jpg"});
#line 126
 testRunner.And("Following thumbnail absents", ((string)(null)), table16);
#line hidden
            this.ScenarioCleanup();
        }
...
#line 132
 testRunner.Given("Habitat Content Editor was opened");
#line 133
 testRunner.When("And User selects Carousel item");
#line 135
 testRunner.And("User removes <Sitecore-Experience.mp4> item from Selected section");
#line 137
 testRunner.And("User clicks Save button on Content Editor Ribbon");
#line 138
 testRunner.And("User publishes /sitecore/content/Shared/Media item with sub-items");
...
#line hidden
            ...
            table17.AddRow(new string[] {
                        "/-/media/Habitat/Videos/Sitecore-Experience.mp4"});
#line 141
 testRunner.And("Following video absents", ((string)(null)), table17);
#line hidden
            this.ScenarioCleanup();
        }
