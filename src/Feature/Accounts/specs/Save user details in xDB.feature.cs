...
#line hidden
    ...
    public static void FeatureSetup()
    {
      ...
      var featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Save user details in xDB", "", ProgrammingLanguage.CSharp, ((string[])(null)));
    ...
    {
      var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Account_Save user details in xDB_UC1_Save full info", new string[]
      {
        "NeedImplementation"
      });
#line 5
...
#line hidden
    ...
    {
      var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Account_Save user details in xDB_UC2_Update full user info", new string[]
      {
        "NeedImplementation"
      });
#line 36
...
#line hidden
    ...
    {
      var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Account_Save user details in xDB_UC3_Save only one of the name fields", new string[]
      {
        "NeedImplementation"
      });
#line 65
...
#line hidden
    ...
    {
      var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Account_Save user details in xDB_UC4_Save only phone number", new string[]
      {
        "NeedImplementation"
      });
#line 93
...
#line hidden
    ...
    {
      var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Account_Save user details in xDB_UC5_Save only Interests", new string[]
      {
        "NeedImplementation"
      });
#line 120
...
#line hidden
    ...
    {
      var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Account_Save user details in xDB_UC6_Update only one of the name fields", new string[]
      {
        "NeedImplementation"
      });
#line 144
...
#line hidden
    ...
    {
      var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Account_Save user details in xDB_UC7_Update only phone number", new string[]
      {
        "NeedImplementation"
      });
#line 169
...
#line hidden
    ...
    {
      var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Account_Save user details in xDB_UC8_Update only only Interests", new string[]
      {
        "NeedImplementation"
      });
#line 193
...
#line hidden
      var table46 = new TechTalk.SpecFlow.Table(new string[]
      {
        "SmtpAddress"
      });
...
#line hidden
      var table47 = new TechTalk.SpecFlow.Table(new string[]
      {
        "\"0\"",
        "\"1\""
      });
...
#line hidden
    ...
    {
      var scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Account_Save user details in xDB_UC9_Update system section in xDB", new string[]
      {
        "NeedImplementation"
      });
#line 216
      this.ScenarioSetup(scenarioInfo);
#line hidden
      var table48 = new TechTalk.SpecFlow.Table(new string[]
      {
        "Email",
        "Password",
        "ConfirmPassword"
...
#line hidden
      var table49 = new TechTalk.SpecFlow.Table(new string[]
      {
        "Email",
        "Password"
      });
...
#line 227
      testRunner.And("User opens MongoDB", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
      var table50 = new TechTalk.SpecFlow.Table(new string[]
      {
        "VisitCount",
        "Value"
      });
