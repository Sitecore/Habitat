...
<div class="cbp-slider">
    <ul class="cbp-slider-wrap">
        ...
        <li class="cbp-slider-item">
            <img src="assets/base/img/content/stock/61.jpg" alt="">
        </li>
        <li class="cbp-slider-item">
...
<div class="cbp-l-project-container">
    ...
    <div class="cbp-l-project-details">
        ...
        <a href="#" target="_blank" class="cbp-l-project-details-visit btn c-btn-square c-btn-border-2x c-btn-dark c-btn-bold c-btn-uppercase">visit the site</a>
    </div>
</div>
    ...
    <div class="cbp-l-project-related">
        ...
        <ul class="cbp-l-project-related-wrap">
            <li class="cbp-l-project-related-item">
                <a href="ajax/masonry-gallery/project12.html" class="cbp-singlePage cbp-l-project-related-link">
                    <img src="assets/base/img/content/stock/64.jpg" alt="">
                    <div class="cbp-l-project-related-title">Speed Detector</div>
                </a>
            </li>
            <li class="cbp-l-project-related-item">
                <a href="ajax/masonry-gallery/project2.html" class="cbp-singlePage cbp-l-project-related-link">
                    <img src="assets/base/img/content/stock/65.jpg" alt="">
                    <div class="cbp-l-project-related-title">World Clock Widget</div>
                </a>
            </li>
            <li class="cbp-l-project-related-item">
                <a href="ajax/masonry-gallery/project3.html" class="cbp-singlePage cbp-l-project-related-link">
