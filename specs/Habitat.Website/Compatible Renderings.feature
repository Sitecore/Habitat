...
Scenario: Compatible Renderings_UC9_Maps module
	Then Feature/Map module contains incompatible renderings
	| Incompatible renderings |
	| Map                     |
...
Scenario: Compatible Renderings_UC12_Multisute module
	Then Feature/Multisute module contains incompatible renderings
	| Incompatible renderings |
	| Site Menu               |
...
Scenario: Compatible Renderings_UC13_Navigation module
	Then <Feature/Navigation> module contains compatible renderings
	| Compatible renderings |
	| Menu with links       |
	| Navigation Links      |
	And Feature/Navigation module contains incompatible renderings
	| Compatible renderings |
	| Breadcrumb            |
	| Primary Menu          |
	| Secondary Menu        |
