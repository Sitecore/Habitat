    ...
    public partial struct Templates
    {
        ...
        public partial struct UserProfile
        {
            ...
            public partial struct Fields
            {
                ...
                public const string FirstName_FieldName = "FirstName";
                public static readonly ID Interest = new ID("{A5D0B0AD-CE4E-4E06-B821-F30416B7DEC9}");
                public const string Interest_FieldName = "Interest";
                public static readonly ID LastName = new ID("{EE21278F-4F83-4A10-8890-66B957F3D312}");
                public const string LastName_FieldName = "LastName";
                public static readonly ID Phone = new ID("{F7A1605F-7BBB-4BC7-BBB4-9E0546648E1D}");
                public const string Phone_FieldName = "Phone";
            }
        }

        public partial struct AccountsSettings
        {
            ...
            public partial struct Fields
            {
                ...
                public const string AccountsDetailsPage_FieldName = "Accounts Details Page";
                public static readonly ID AfterLoginPage = new ID("{B128E2B3-3865-4F1C-A147-5F248676D3F5}");
                public const string AfterLoginPage_FieldName = "After Login Page";
                public static readonly ID ForgotPasswordMailTemplate = new ID("{365254C4-1C1C-493A-9710-671574717898}");
                public const string ForgotPasswordMailTemplate_FieldName = "Forgot Password Mail Template";
                public static readonly ID ForgotPasswordPage = new ID("{F3CD2BB8-472B-4DF0-87C0-A13098E391CA}");
                public const string ForgotPasswordPage_FieldName = "Forgot Password Page";
                ...
                public const string RegisterOutcome_FieldName = "Register Outcome";
                public static readonly ID RegisterPage = new ID("{71962360-10D8-4B98-BB8D-57660CE11127}");
                public const string RegisterPage_FieldName = "Register Page";
            }
        }

        public partial struct Interest
        {
        ...
        public partial struct LoginTeaser
        {
            ...
            public partial struct Fields
            {
                ...
                public const string LoggedInSummary_FieldName = "Logged In Summary";
                public static readonly ID LoggedInTitle = new ID("{39AABCF6-426C-4AD1-8B3D-A5135F219455}");
                public const string LoggedInTitle_FieldName = "Logged In Title";
        ...
        public partial struct MailTemplate
        {
            ...
            public partial struct Fields
            {
                ...
                public const string From_FieldName = "From";
        ...
        public partial struct ProfileSettings
        {
            ...
            public partial struct Fields
            {
                ...
                public const string InterestsFolder_FieldName = "Interests Folder";
                public static readonly ID UserProfile = new ID("{378B7D87-5775-4EB6-86B7-282D5359B1C6}");
                public const string UserProfile_FieldName = "User Profile";
            }
        }
    }
}