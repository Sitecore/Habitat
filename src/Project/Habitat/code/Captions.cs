namespace Sitecore.Habitat.Website
{
  ...
  public static class Captions
  {
    ...
    public static string EndVisit => DictionaryRepository.Get("/Website/Captions/EndVisit", "End the current visit and submit it to the Sitecore Experience Database");
  }
}